...
define('SCHEMA_FILE', SCHEMA_DIR . '/' . TESTSCHEMA_VERSION . '/cyclonedx-' . TESTSCHEMA_VERSION . '.schema.json');
...
$resolver->registerPrefix('https://cyclonedx.org/schema/', SCHEMA_DIR);
